    ...
    <div class="modal-dialog width_modal_journal height100-s">
        <div class="modal-content quotation_container height100-s">
            <div class="modal-header journal_modal_header">
                ...
                <h4 class="modal-title journal_pop_hdg pull-left" >Test Quotation#
...
if(isset($detail)){
                    ...
                    <td>
                        <select name="product__id_" id="showproducts" class="form-control selectpicker cus-lines-s">
                              ...
                              <input type="hidden" name="pservices_index_id[]" class="pro_name" id="pro_name" value="<?php if(isset($detail[$i]['pservices_index_id'])){ echo $detail[$i]['pservices_index_id'];}?>">
                                <input type="hidden" name="p_quotation_id[]" class="form-control  tableInput " value="<?php if(isset($detail[$i]['p_quotation_id'])){ echo $detail[$i]['p_quotation_id'];}?>">
                               
                         
                            <td class="text-left show_des_d selector-text-s move-up-down-row-d" valign="middle">
                                <input type="text" name="description[]" class="form-control des_d tableInput " value="<?php if(isset($detail[$i]['description'])){ echo $detail[$i]['description'];}?>">
...
<?php }}else{ ?>
                       ...
                       <td>
                           <select name="product__id_" id="showproducts" class="form-control selectpicker cus-lines-s" >
                              ...
                              <input type="hidden" name="pservices_index_id[]" class="pro_name" id="pro_name">
                            <td class="text-left show_des_d selector-text-s move-up-down-row-d" valign="middle">
                                <input type="text" name="description[]" class="form-control des_d tableInput ">
...
<a href="#" class="btn btn-primary test-slide qoutation_recurring_slide p-1-1" data-toggle="modal" data-target="#quotation_qbo_recurring">Make Recurring</a>
    ...
    <div class="col-sm-4 col-md-4 col-lg-3 col-xs-6 account_new_import line-hit p-xs-0">
             <?php if(isset($result[0]['quotation_index_id'])){?>
<input type="button" class="btn btn-primary send_email" value="Save &amp; Send" style="float:right;">
         <?php }?>
         </div>
                <div class="clearfix"></div>
            </div>
...
<!-- load save and send -->     
<?php $this->load->view('popup/test-make-recurring'); ?>
